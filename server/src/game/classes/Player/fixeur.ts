...
export class Fixeur extends Player {
  ...
  //utilise le power de fixeur,
  //role fixeur -> repare l'outil d'un joueur -> return true si un outil a été réparé, false sinon
  public power(
    targetPlayer: Player,
    pickaxe: boolean,
    cart: boolean,
    ...
    let bonus = new Bonus(110, false, pickaxe, cart, torch);
